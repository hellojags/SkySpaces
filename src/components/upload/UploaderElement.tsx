...
export default function UploaderElement({upload,skypath}) {
      ...
      (async () => {
        ...
        try {
          ...
          if (upload.mode === 'directory') {
            ...
            response = await createFile1(skyfsPath,upload.file,upload.file.name,onUploadProgress);
          } else {
